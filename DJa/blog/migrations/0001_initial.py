    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, default='', max_length=1000, verbose_name='Описание категории')),
                ('template', models.CharField(default='blog/sport_list.html', max_length=500, verbose_name='Шаблон')),
                ('published', models.BooleanField(default=True, verbose_name='Отображать?')),
                ('paginated', models.PositiveIntegerField(default=5, verbose_name='Кол-во новостей на страние')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text', models.TextField(max_length=2000000, verbose_name='Описание')),
                ('created_date', models.DateTimeField(auto_now_add=True, verbose_name='Дата создания')),
                ('edit_date', models.DateTimeField(blank=True, default=django.utils.timezone.now, null=True, verbose_name='Дата изменения')),
                ...
                ('category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='category', to='blog.category', verbose_name='Категория')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('moderation', models.BooleanField(default=True, verbose_name='Модерация пройдена')),
